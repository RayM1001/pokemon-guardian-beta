...
(function (global) {
  ...
  const STRINGS = {
    zh_tw: {
      // 首頁
      homeTitle:    '我的寶可夢日常搭檔',
      homeTagline:  '今天，適合哪位寶可夢陪你？',
      homeSubtitle: '從出生日期、目前狀態與生活場景，找出今天適合陪在你身邊的寶可夢。',
      startBtn:     '開始測驗',
    ...
    en: {
      homeTitle:    'My Pokémon Daily Partner',
      homeTagline:  'Which Pokémon suits you today?',
      homeSubtitle: 'Based on your birth date, how you feel today, and your living spaces — discover the Pokémon that fit your day.',
      startBtn:     'Start Quiz',
      ...
      s4Desc:     'Choose the space you spend the most time in or want to set up.',
      s5Title:              "Today's Daily Partner Setup",
      energySummaryTitle:   'Today\'s Energy Reading',
      energySummaryPrefix:  'Today\'s setup focus: ',
      slotFavorite:         'Favorite Partner',
      slotMain:             "Today's Main Partner",
      slotScene:            'Space Partner',
      slotBalance:          'Balance Partner',
      ...
      shareCopied:          'Copied!',
      shareTitle:           'My Pokémon Daily Partner:',
      ...
      shareCardTitle:       'My Pokémon Daily Partner',
      shareCardSubtitle:    "Today's Setup",
    ...
    ja: {
      homeTitle:    'わたしのポケモン日常パートナー診断',
      homeTagline:  '今日、そばにいてほしいポケモンは？',
      homeSubtitle: '生年月日・今の状態・生活の場面から、今日そばにいてほしいポケモンを見つけてみましょう。',
      startBtn:     '診断スタート',
      ...
      s4Title:    'ポケモンをどの場面に置きますか？',
      s4Desc:     '一番よくいる場所、または整えたいと思う空間を選んでください。',
      s5Title:              '今日の日常パートナー配置',
      energySummaryTitle:   '今日のエネルギー分析',
      energySummaryPrefix:  '今日の配置テーマ：',
      slotFavorite:         '大切な相棒',
      slotMain:             '今日のメインパートナー',
      slotScene:            '空間のパートナー',
      slotBalance:          'バランスパートナー',
      labelDexNo:           '全国図鑑番号',
      labelElement:         '五行の気質',
      labelTypes:           '公式タイプ',
      labelReason:          'おすすめの理由',
